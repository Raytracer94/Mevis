isEmpty(Hannes_General_PRI_INCLUDED) {
  message ( loading Hannes_General.pri )
}
# **InsertLicense** code
# -----------------------------------------------------------------------------
# Hannes_General prifile
#
# \file    Hannes_General.pri
...
PACKAGE_ROOT    = $$(MLAB_Hannes_General)
